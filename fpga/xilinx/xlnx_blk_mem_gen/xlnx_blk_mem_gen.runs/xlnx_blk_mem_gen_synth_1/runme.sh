...
HD_PWD='/home/boyer/git_complet_pro/Thales_contest/fpga/xilinx/xlnx_blk_mem_gen/xlnx_blk_mem_gen.runs/xlnx_blk_mem_gen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xlnx_blk_mem_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xlnx_blk_mem_gen.tcl
