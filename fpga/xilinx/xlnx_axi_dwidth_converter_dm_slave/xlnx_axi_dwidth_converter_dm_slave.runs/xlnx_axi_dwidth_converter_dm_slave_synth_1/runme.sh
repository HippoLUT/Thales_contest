...
HD_PWD='/home/boyer/git_complet_pro/Thales_contest/fpga/xilinx/xlnx_axi_dwidth_converter_dm_slave/xlnx_axi_dwidth_converter_dm_slave.runs/xlnx_axi_dwidth_converter_dm_slave_synth_1'
cd "$HD_PWD"
