...
HD_PWD='/home/boyer/git_complet_pro/Thales_contest/fpga/xilinx/xlnx_processing_system7/xlnx_processing_system7.runs/xlnx_processing_system7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log xlnx_processing_system7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source xlnx_processing_system7.tcl
